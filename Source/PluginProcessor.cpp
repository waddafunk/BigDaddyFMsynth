...
//==============================================================================
const String Fm_synthAudioProcessor::getName() const
{
...
const String Fm_synthAudioProcessor::getProgramName (int index)
{
    return {};
}

void Fm_synthAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void Fm_synthAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* Fm_synthAudioProcessor::createEditor()
{
    return new Fm_synthAudioProcessorEditor (*this);
}

//==============================================================================
void Fm_synthAudioProcessor::getStateInformation (MemoryBlock& destData)
{
